...
const students = [
  { id: 1, name: 'rahul ', email: 'rahul@example.com', course: 'Backend Development', semester: '6' },
  { id: 2, name: 'Priya Sharma', email: 'priya@example.com', course: 'Node JS', semester: '6' },
  { id: 3, name: 'Rohan Gupta', email: 'rohan@example.com', course: 'Express JS', semester: '6' }
];
